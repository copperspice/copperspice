...
#ifndef QWAYLAND_SHELL_INTEGRATIONPLUGIN_H
#define QWAYLAND_SHELL_INTEGRATIONPLUGIN_H
...
#define QWaylandShellIntegrationFactoryInterface_ID "com.copperspice.CS.WaylandClient.QWaylandShellIntegrationFactoryInterface"

class Q_WAYLAND_CLIENT_EXPORT QWaylandShellIntegrationPlugin : public QObject
{
   CS_OBJECT(QWaylandShellIntegrationPlugin)
