...
template<class T, class F, class enumName, class scope, class flagName>
const int cs_record_flag<T, F, enumName, scope, flagName>::placeholder = const_cast<QMetaObject_T<T>&>(T::staticMetaObject())
...
template<class T, class name, class U, U method, QMetaProperty::Kind K>
const int cs_record_property_read<T, name, U, method, K>::placeholder = const_cast<QMetaObject_T<T>&>(T::staticMetaObject())
...
template<class T, class name, class U, U method, QMetaProperty::Kind K>
const int cs_record_property_notify<T, name, U, method, K>::placeholder = record_property_notify<T, name, U, method, K>();
