...
public:
    ...
    inline void setSharable(bool sharable) 
		{ if (!sharable) detach(); if (d != QMapData::sharedNull() ) d->sharable = sharable; }

    inline bool isSharedWith(const QMap<Key, T> &other) const { return d == other.d; }
    inline void setInsertInOrder(bool ordered) { if (ordered) detach(); if ( d !=  QMapData::sharedNull() ) d->insertInOrder = ordered; }
