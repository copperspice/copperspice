...
public:
    ...
    inline void setActive(bool b) { setActive(Any, b); }
    void setActive(Action ac, bool b);
    inline bool isActive() const { return isActive(Any); }
    bool isActive(Action ac) const;
    inline void setMovingEnabled(bool b) { movingEnabled = b; }
    inline bool isMovingEnabled() const { return movingEnabled; }

    inline bool isButtonDown() const { return buttonDown; }

    inline void setExtraHeight(int h) { extrahei = h; }
    inline void setSizeProtection(bool b) { sizeprotect = b; }

    inline void setFrameWidth(int w) { fw = w; }
