...
template <class DST>
inline Q_STATIC_TEMPLATE_FUNCTION uint *QT_FASTCALL destFetch(uint *buffer, QRasterBuffer *rasterBuffer,
...
template <class DST>
inline Q_STATIC_TEMPLATE_FUNCTION void QT_FASTCALL destStore(QRasterBuffer *rasterBuffer,
      int x, int y,
...
inline Q_STATIC_TEMPLATE_FUNCTION uint QT_FASTCALL qt_fetchPixel(const uchar *scanLine, int x,
      ...
      int x, const QVector<QRgb> *rgb)
{
   ...
   if (rgb) {
      return PREMUL(rgb->at(pixel ? 1 : 0));
   }
...
template <QImage::Format format>
inline Q_STATIC_TEMPLATE_FUNCTION const uint *QT_FASTCALL qt_fetchUntransformed(uint *buffer, const Operator *,
...
inline Q_STATIC_TEMPLATE_FUNCTION
...
inline Q_STATIC_TEMPLATE_FUNCTION  void fetchTransformedBilinear_pixelBounds(int max, int l1, int l2, int &v1, int &v2)
{
...
const uint *QT_FASTCALL fetchTransformedBilinear(uint *buffer, const Operator *, const QSpanData *data,
      int y, int x, int length)
{
   FetchPixelProc fetch = (format != QImage::Format_Invalid) ? FetchPixelProc(qt_fetchPixel<format>) :
                          fetchPixelProc[data->texture.format];
...
#define BILINEAR_DOWNSCALE_BOUNDS_PROLOG \
               ...
               while (b < boundedEnd) {
                  ...
                  interpolate_4_pixels_16_neon(vreinterpretq_s16_s32(tl.vect), vreinterpretq_s16_s32(tr.vect),
                                               vreinterpretq_s16_s32(bl.vect), vreinterpretq_s16_s32(br.vect), vreinterpretq_s16_s32(v_distx), v_disty, v_disty_,
...
void QT_FASTCALL comp_func_Source(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
                                  uint const_alpha)
{
   if (const_alpha == 255) {
...
void QT_FASTCALL comp_func_SourceOver(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
                                      uint const_alpha)
{
   PRELOAD_INIT2(dest, src)
   if (const_alpha == 255) {
...
void QT_FASTCALL comp_func_DestinationOver(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
      uint const_alpha)
{
   PRELOAD_INIT2(dest, src)
   if (const_alpha == 255) {
...
void QT_FASTCALL comp_func_SourceIn(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
                                    uint const_alpha)
{
   PRELOAD_INIT2(dest, src)
   if (const_alpha == 255) {
...
void QT_FASTCALL comp_func_DestinationIn(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
      uint const_alpha)
{
   PRELOAD_INIT2(dest, src)
   if (const_alpha == 255) {
...
void QT_FASTCALL comp_func_SourceOut(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
                                     uint const_alpha)
{
   PRELOAD_INIT2(dest, src)
   if (const_alpha == 255) {
...
void QT_FASTCALL comp_func_DestinationOut(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
      uint const_alpha)
{
   PRELOAD_INIT2(dest, src)
   if (const_alpha == 255) {
...
void QT_FASTCALL comp_func_SourceAtop(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
                                      uint const_alpha)
{
   PRELOAD_INIT2(dest, src)
   if (const_alpha == 255) {
...
void QT_FASTCALL comp_func_DestinationAtop(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
      uint const_alpha)
{
   PRELOAD_INIT2(dest, src)
   if (const_alpha == 255) {
...
void QT_FASTCALL comp_func_XOR(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
                               uint const_alpha)
{
   PRELOAD_INIT2(dest, src)
   if (const_alpha == 255) {
...
*/
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_solid_Plus_impl(uint *dest, int length, uint color, const T &coverage)
{
   uint s = color;
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_Plus_impl(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src,
      int length, const T &coverage)
{
   PRELOAD_INIT2(dest, src)
   for (int i = 0; i < length; ++i) {
      PRELOAD_COND2(dest, src)
...
void QT_FASTCALL comp_func_Plus(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
                                uint const_alpha)
{
   if (const_alpha == 255) {
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_solid_Multiply_impl(uint *dest, int length, uint color,
      const T &coverage)
{
   int sa = qAlpha(color);
   int sr = qRed(color);
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_Multiply_impl(uint *Q_DECL_RESTRICT dest,
      const uint *Q_DECL_RESTRICT src, int length, const T &coverage)
{
   PRELOAD_INIT2(dest, src)
   for (int i = 0; i < length; ++i) {
      PRELOAD_COND2(dest, src)
...
void QT_FASTCALL comp_func_Multiply(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
                                    uint const_alpha)
{
   if (const_alpha == 255) {
...
*/
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_solid_Screen_impl(uint *dest, int length, uint color,
      const T &coverage)
{
   int sa = qAlpha(color);
   int sr = qRed(color);
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_Screen_impl(uint *Q_DECL_RESTRICT dest,
      const uint *Q_DECL_RESTRICT src, int length, const T &coverage)
{
   PRELOAD_INIT2(dest, src)
   for (int i = 0; i < length; ++i) {
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_solid_Overlay_impl(uint *dest, int length, uint color,
      const T &coverage)
{
   int sa = qAlpha(color);
   int sr = qRed(color);
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_Overlay_impl(uint *Q_DECL_RESTRICT dest,
      const uint *Q_DECL_RESTRICT src, int length, const T &coverage)
{
   PRELOAD_INIT2(dest, src)
   for (int i = 0; i < length; ++i) {
...
void QT_FASTCALL comp_func_Overlay(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
                                   uint const_alpha)
{
   if (const_alpha == 255) {
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_solid_Darken_impl(uint *dest, int length, uint color,
      const T &coverage)
{
   int sa = qAlpha(color);
   int sr = qRed(color);
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_Darken_impl(uint *Q_DECL_RESTRICT dest,
      const uint *Q_DECL_RESTRICT src, int length, const T &coverage)
{
   PRELOAD_INIT2(dest, src)
   for (int i = 0; i < length; ++i) {
...
void QT_FASTCALL comp_func_Darken(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
                                  uint const_alpha)
{
   if (const_alpha == 255) {
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_solid_Lighten_impl(uint *dest, int length, uint color,
      const T &coverage)
{
   int sa = qAlpha(color);
   int sr = qRed(color);
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_Lighten_impl(uint *Q_DECL_RESTRICT dest,
      const uint *Q_DECL_RESTRICT src, int length, const T &coverage)
{
   PRELOAD_INIT2(dest, src)
   for (int i = 0; i < length; ++i) {
...
void QT_FASTCALL comp_func_Lighten(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
                                   uint const_alpha)
{
   if (const_alpha == 255) {
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_solid_ColorDodge_impl(uint *dest, int length, uint color,
      const T &coverage)
{
   int sa = qAlpha(color);
   int sr = qRed(color);
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_ColorDodge_impl(uint *Q_DECL_RESTRICT dest,
      const uint *Q_DECL_RESTRICT src, int length, const T &coverage)
{
   PRELOAD_INIT2(dest, src)
   for (int i = 0; i < length; ++i) {
...
void QT_FASTCALL comp_func_ColorDodge(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
                                      uint const_alpha)
{
   if (const_alpha == 255) {
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_solid_ColorBurn_impl(uint *dest, int length, uint color,
      const T &coverage)
{
   int sa = qAlpha(color);
   int sr = qRed(color);
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_ColorBurn_impl(uint *Q_DECL_RESTRICT dest,
      const uint *Q_DECL_RESTRICT src, int length, const T &coverage)
{
   PRELOAD_INIT2(dest, src)
   for (int i = 0; i < length; ++i) {
...
void QT_FASTCALL comp_func_ColorBurn(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
                                     uint const_alpha)
{
   if (const_alpha == 255) {
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_solid_HardLight_impl(uint *dest, int length, uint color,
      const T &coverage)
{
   int sa = qAlpha(color);
   int sr = qRed(color);
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_HardLight_impl(uint *Q_DECL_RESTRICT dest,
      const uint *Q_DECL_RESTRICT src, int length, const T &coverage)
{
   PRELOAD_INIT2(dest, src)
   for (int i = 0; i < length; ++i) {
...
void QT_FASTCALL comp_func_HardLight(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
                                     uint const_alpha)
{
   if (const_alpha == 255) {
...
static inline int soft_light_op(int dst, int src, int da, int sa)
{
   ...
   if (src2 < sa) {
      ...
      return (dst * sa * 255 + da * (src2 - sa) * ((((16 * dst_np - 12 * 255) * dst_np + 3 * 65025) * dst_np) / 65025) +
              temp) / 65025;
   }
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_solid_SoftLight_impl(uint *dest, int length, uint color,
      const T &coverage)
{
   int sa = qAlpha(color);
   int sr = qRed(color);
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_SoftLight_impl(uint *Q_DECL_RESTRICT dest,
      const uint *Q_DECL_RESTRICT src, int length, const T &coverage)
{
   PRELOAD_INIT2(dest, src)
   for (int i = 0; i < length; ++i) {
...
void QT_FASTCALL comp_func_SoftLight(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
                                     uint const_alpha)
{
   if (const_alpha == 255) {
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_solid_Difference_impl(uint *dest, int length, uint color,
      const T &coverage)
{
   int sa = qAlpha(color);
   int sr = qRed(color);
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_Difference_impl(uint *Q_DECL_RESTRICT dest,
      const uint *Q_DECL_RESTRICT src, int length, const T &coverage)
{
   PRELOAD_INIT2(dest, src)
   for (int i = 0; i < length; ++i) {
...
void QT_FASTCALL comp_func_Difference(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
                                      uint const_alpha)
{
   if (const_alpha == 255) {
...
*/
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void QT_FASTCALL comp_func_solid_Exclusion_impl(uint *dest, int length, uint color,
      const T &coverage)
{
   int sa = qAlpha(color);
   int sr = qRed(color);
...
template <typename T>
inline Q_STATIC_TEMPLATE_FUNCTION  void comp_func_Exclusion_impl(uint *Q_DECL_RESTRICT dest,
      const uint *Q_DECL_RESTRICT src, int length, const T &coverage)
{
   PRELOAD_INIT2(dest, src)
   for (int i = 0; i < length; ++i) {
...
void QT_FASTCALL comp_func_Exclusion(uint *Q_DECL_RESTRICT dest, const uint *Q_DECL_RESTRICT src, int length,
                                     uint const_alpha)
{
   if (const_alpha == 255) {
...
template <class T>
inline Q_STATIC_TEMPLATE_FUNCTION void blendColor(int count, const QSpan *spans, void *userData)
{
   QSpanData *data = reinterpret_cast<QSpanData *>(userData);
   Operator op = getOperator(data, spans, count);
...
template <SpanMethod spanMethod>
inline Q_STATIC_TEMPLATE_FUNCTION void blend_src_generic(int count, const QSpan *spans, void *userData)
{
   QSpanData *data = reinterpret_cast<QSpanData *>(userData);
...
template <SpanMethod spanMethod>
inline Q_STATIC_TEMPLATE_FUNCTION void blend_untransformed_generic(int count, const QSpan *spans, void *userData)
{
   QSpanData *data = reinterpret_cast<QSpanData *>(userData);
...
template <SpanMethod spanMethod>
inline Q_STATIC_TEMPLATE_FUNCTION void blend_untransformed_argb(int count, const QSpan *spans, void *userData)
{
   QSpanData *data = reinterpret_cast<QSpanData *>(userData);
...
template <SpanMethod spanMethod>
inline Q_STATIC_TEMPLATE_FUNCTION void blend_tiled_generic(int count, const QSpan *spans, void *userData)
{
   QSpanData *data = reinterpret_cast<QSpanData *>(userData);
...
template <SpanMethod spanMethod>
inline Q_STATIC_TEMPLATE_FUNCTION void blend_tiled_argb(int count, const QSpan *spans, void *userData)
{
   QSpanData *data = reinterpret_cast<QSpanData *>(userData);
   if (data->texture.format != QImage::Format_ARGB32_Premultiplied
         && data->texture.format != QImage::Format_RGB32) {
...
template <class DST, class SRC>
inline Q_STATIC_TEMPLATE_FUNCTION void blendTiled(int count, const QSpan *spans, void *userData)
{
   QSpanData *data = reinterpret_cast<QSpanData *>(userData);
   QPainter::CompositionMode mode = data->rasterBuffer->compositionMode;
...
template <class DST, class SRC>
inline Q_STATIC_TEMPLATE_FUNCTION void blendTransformedBilinear(int count, const QSpan *spans,
      void *userData)
{
   QSpanData *data = reinterpret_cast<QSpanData *>(userData);
   QPainter::CompositionMode mode = data->rasterBuffer->compositionMode;
...
template <SpanMethod spanMethod>
inline Q_STATIC_TEMPLATE_FUNCTION void blend_transformed_argb(int count, const QSpan *spans, void *userData)
{
   QSpanData *data = reinterpret_cast<QSpanData *>(userData);
   if (data->texture.format != QImage::Format_ARGB32_Premultiplied
         && data->texture.format != QImage::Format_RGB32) {
...
template <class DST, class SRC>
inline Q_STATIC_TEMPLATE_FUNCTION void blendTransformed(int count, const QSpan *spans, void *userData)
{
   QSpanData *data = reinterpret_cast<QSpanData *>(userData);
   QPainter::CompositionMode mode = data->rasterBuffer->compositionMode;
...
template <SpanMethod spanMethod>
inline Q_STATIC_TEMPLATE_FUNCTION void blend_transformed_tiled_argb(int count, const QSpan *spans, void *userData)
{
   QSpanData *data = reinterpret_cast<QSpanData *>(userData);
   if (data->texture.format != QImage::Format_ARGB32_Premultiplied
         && data->texture.format != QImage::Format_RGB32) {
...
template <class DST, class SRC>
inline Q_STATIC_TEMPLATE_FUNCTION void blendTransformedTiled(int count, const QSpan *spans, void *userData)
{
   QSpanData *data = reinterpret_cast<QSpanData *>(userData);
   QPainter::CompositionMode mode = data->rasterBuffer->compositionMode;
...
void qInitDrawhelperAsm()
{
   ...
   if (features & MMX) {
      ...
      qBlendFunctions[QImage::Format_ARGB32_Premultiplied][QImage::Format_ARGB32_Premultiplied] =
   ...
   if (features & NEON) {
      ...
      qTransformFunctions[QImage::Format_RGB16][QImage::Format_ARGB32_Premultiplied] =
...
inline Q_STATIC_TEMPLATE_FUNCTION  void qt_rectconvert_rgb(qrgb *dest, const SRC *src,
      int x, int y, int width, int height,
