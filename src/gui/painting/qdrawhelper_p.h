...
typedef const uint *(QT_FASTCALL *SourceFetchProc)(uint *buffer, const Operator *o, const QSpanData *data, int y, int x,
      int length);
...
class qabgr8888
{
 public:
   ...
   inline bool operator==(const qabgr8888 &v) const {
      return data == v.data;
   }
...
class qrgb555
{
 public:
   ...
   inline explicit qrgb555(quint32p v) {
      *this = qrgb555(quint32(v));
   }
...
{
 public:
   inline qbgr555(quint32 v) {
      *this = qbgr555(qrgb555(v));
   }
...
class qargb6666
{
 public:
   ...
   inline qargb6666() {}
   inline qargb6666(quint32 v) {
      *this = qargb6666(quint32p(v));
   }
...
class qargb4444
{
 public:
   ...
   inline qargb4444() {}
   inline qargb4444(quint32 v) {
      *this = qargb4444(quint32p(v));
   }
   ...
   inline quint8 alpha() const {
      return ((data & 0xf000) >> 8) | ((data & 0xf000) >> 12);
   }
   inline qargb4444 truncedAlpha() {
      return *this;
   }
   Q_STATIC_INLINE_FUNCTION quint8 alpha(quint8 a) {
      return (a + 1) >> 4;
   ...
   inline bool operator==(const qargb4444 &v) const {
      return data == v.data;
   }
...
class qrgb444
{
 public:
   ...
   inline bool operator==(const qrgb444 &v) const {
      return data == v.data;
   }
   inline bool operator!=(const qrgb444 &v) const {
      return data != v.data;
...
class qrgb_generic16
{
 public:
   ...
   inline quint32 operator<<(int shift) const {
      return data << shift;
   }
...
inline void qt_memconvert(DST *dest, const SRC *src, int count)
{
   if (sizeof(DST) == 1) {
      ...
      switch (count & 0x07) {
         case 0:
            do {
               *dest++ = qt_colorConvert<DST, SRC>(*src++, 0);
            case 7:
               *dest++ = qt_colorConvert<DST, SRC>(*src++, 0);
            case 6:
               *dest++ = qt_colorConvert<DST, SRC>(*src++, 0);
