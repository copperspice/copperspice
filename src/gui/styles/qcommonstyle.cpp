    ...
    if (QApplication::desktopSettingsAware()) {
        ...
        case SP_TitleBarCloseButton: {
            ...
            if (standardIcon == SP_TitleBarCloseButton) {
                ...
                titleBarIcon.addFile(QLatin1String(":/copperspice/styles/macstyle/images/closedock-down-16.png"), QSize(16, 16), QIcon::Normal, QIcon::On);
            } else {
                titleBarIcon.addFile(QLatin1String(":/copperspice/styles/macstyle/images/dockdock-16.png"));
                titleBarIcon.addFile(QLatin1String(":/copperspice/styles/macstyle/images/dockdock-down-16.png"), QSize(16, 16), QIcon::Normal, QIcon::On);
            }
            return titleBarIcon;
        }
        default:
