...
class Q_GUI_EXPORT_STYLE_MAC QMacStyle : public QWindowsStyle
{
 ...
 public:
   ...
   SubControl hitTestComplexControl(ComplexControl cc, const QStyleOptionComplex *opt, const QPoint &pt, const QWidget *w = 0) const override;

   QRect subControlRect(ComplexControl cc, const QStyleOptionComplex *opt, SubControl sc, const QWidget *w = 0) const override;
   QSize sizeFromContents(ContentsType ct, const QStyleOption *opt,const QSize &contentsSize, const QWidget *w = 0) const override;

   int pixelMetric(PixelMetric pm, const QStyleOption *opt = 0, const QWidget *widget = 0) const override;

   QPalette standardPalette() const override;

   virtual int styleHint(StyleHint sh, const QStyleOption *opt = 0, const QWidget *w = 0, QStyleHintReturn *shret = 0) const override;
