...
void QGtkStylePrivate::resolveGtk() const
{
   ...
   gtk_file_chooser_set_current_folder = (Ptr_gtk_file_chooser_set_current_folder)
                                         libgtk.resolve("gtk_file_chooser_set_current_folder");
   ...
   gtk_file_chooser_set_current_name = (Ptr_gtk_file_chooser_set_current_name)
                                       libgtk.resolve("gtk_file_chooser_set_current_name");
   ...
   gtk_widget_set_default_direction = (Ptr_gtk_widget_set_default_direction)
                                      libgtk.resolve("gtk_widget_set_default_direction");
   ...
   gtk_icon_factory_lookup_default = (Ptr_gtk_icon_factory_lookup_default)
                                     libgtk.resolve("gtk_icon_factory_lookup_default");
   ...
   pango_font_description_get_size = (Ptr_pango_font_description_get_size)
                                     libgtk.resolve("pango_font_description_get_size");
      ...
      QMap<GtkFileFilter *, QString> *filterMap)
{
   ...
   if (fileinfo.isDir()) {
      ...
      QGtkStylePrivate::gtk_file_chooser_set_current_folder((GtkFileChooser *)gtkFileChooser,
...
QString QGtkStylePrivate::openFilename(QWidget *parent, const QString &caption, const QString &dir,
...
QString QGtkStylePrivate::openDirectory(QWidget *parent, const QString &caption, const QString &dir,
...
QStringList QGtkStylePrivate::openFilenames(QWidget *parent, const QString &caption, const QString &dir,
      const QString &filter,
      QString *selectedFilter, QFileDialog::Options options)
{
...
QString QGtkStylePrivate::saveFilename(QWidget *parent, const QString &caption, const QString &dir,
                                       const QString &filter,
                                       QString *selectedFilter, QFileDialog::Options options)
{
   QMap<GtkFileFilter *, QString> filterMap;
