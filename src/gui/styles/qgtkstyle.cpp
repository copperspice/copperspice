         ...
         if (const QStyleOptionMenuItem *menuItem = qstyleoption_cast<const QStyleOptionMenuItem *>(option)) {
            ...
            if (menuItem->menuItemType == QStyleOptionMenuItem::SubMenu) {// draw sub menu arrow
               ...
               gtkPainter.paintArrow(gtkMenuItem, "menuitem", vSubMenuRect,
                                     QApplication::isRightToLeft() ? GTK_ARROW_LEFT : GTK_ARROW_RIGHT, state,
   ...
   switch (type) {
      ...
      case CT_ComboBox:
         if (const QStyleOptionComboBox *combo = qstyleoption_cast<const QStyleOptionComboBox *>(option)) {
            ...
            newSize = size + QSize(12 + arrowButtonRect.width() + 2 * gtkCombo->style->xthickness,
                                   4 + 2 * gtkCombo->style->ythickness);
      ...
      case CT_GroupBox:
         newSize += QSize(4, groupBoxBottomMargin + groupBoxTopMargin +
                          groupBoxTitleMargin); // Add some space below the groupbox
         break;
