...
int QTextDocumentPrivate::insert_block(quint32 pos, uint strPos, int format, int blockFormat,
...
void QTextDocumentPrivate::setCharFormat(quint32 pos, int length, const QTextCharFormat &newFormat,
