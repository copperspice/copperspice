...
public:
    ...
    GUI_CS_SIGNAL_1(Public, void play(int un_named_arg1,int un_named_arg2,const QString & un_named_arg3,int un_named_arg4,int un_named_arg5))
    GUI_CS_SIGNAL_OVERLOAD(play,(int,int,const QString &,int,int),un_named_arg1,un_named_arg2,un_named_arg3,un_named_arg4,un_named_arg5) 
   
    GUI_CS_SIGNAL_1(Public, void playRaw(int un_named_arg1,int un_named_arg2,const QString & un_named_arg3,int un_named_arg4,
                  int un_named_arg5,int un_named_arg6,int un_named_arg7))
    GUI_CS_SIGNAL_2(playRaw,un_named_arg1,un_named_arg2,un_named_arg3,un_named_arg4,un_named_arg5,un_named_arg6,un_named_arg7) 
...
void QWSSoundServerSocket::newConnection()
{
    while (QWS_SOCK_BASE *sock = nextPendingConnection()) {
        ...
        connect(client, SIGNAL(play(int,int,const QString &,int,int)), this, SLOT(playFile(int,int,const QString &,int,int)));
...
public:
   ...
   connect(this, SIGNAL(deviceError(int,int,int)),    server, SLOT(deviceError(int,int,int)));
    ...
    //
    GUI_CS_SLOT_1(Public, void playRawFile(int wid,int sid,const QString & filename,int freq,int channels,int bitspersample,int flags))
