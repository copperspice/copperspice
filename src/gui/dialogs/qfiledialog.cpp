...
void QFileDialogPrivate::createWidgets()
{
    ...
    QObject::connect(qFileDialogUi->lookInCombo, SIGNAL(activated(const QString &)), q, SLOT(_q_goToDirectory(const QString &)));
    ...
    QObject::connect(qFileDialogUi->fileTypeCombo, SIGNAL(activated(const QString &)),q, SLOT(filterSelected(const QString &)));
