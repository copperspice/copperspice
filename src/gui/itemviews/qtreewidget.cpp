...
QModelIndex QTreeModel::parent(const QModelIndex &child) const
{
   SkipSorting skipSorting(
      this); //The reason we don't sort here is that this might be called from a valid QPersistentModelIndex
   ...
   : QTreeView(*new QTreeWidgetPrivate(), parent)
{
   ...
   connect(this, SIGNAL(pressed(const QModelIndex &)),       this, SLOT(_q_emitItemPressed(const QModelIndex &)));
   connect(this, SIGNAL(clicked(const QModelIndex &)),       this, SLOT(_q_emitItemClicked(const QModelIndex &)));
   connect(this, SIGNAL(doubleClicked(const QModelIndex &)), this, SLOT(_q_emitItemDoubleClicked(const QModelIndex &)));
   connect(this, SIGNAL(activated(const QModelIndex &)),     this, SLOT(_q_emitItemActivated(const QModelIndex &)));
   connect(this, SIGNAL(entered(const QModelIndex &)),       this, SLOT(_q_emitItemEntered(const QModelIndex &)));
   connect(this, SIGNAL(expanded(const QModelIndex &)),      this, SLOT(_q_emitItemExpanded(const QModelIndex &)));
   connect(this, SIGNAL(collapsed(const QModelIndex &)),     this, SLOT(_q_emitItemCollapsed(const QModelIndex &)));

   connect(selectionModel(), SIGNAL(currentChanged(const QModelIndex &, const QModelIndex &)),
           this, SLOT(_q_emitCurrentItemChanged(const QModelIndex &, const QModelIndex &)));

   connect(model(), SIGNAL(dataChanged(const QModelIndex &, const QModelIndex &)),
           this, SLOT(_q_emitItemChanged(const QModelIndex &)));
   ...
   connect(selectionModel(), SIGNAL(selectionChanged(const QItemSelection &, const QItemSelection &)),
           this, SLOT(_q_selectionChanged(const QItemSelection &, const QItemSelection &)));
