...
void QIdentityProxyModel::_q_sourceRowsAboutToBeRemoved(const QModelIndex & un_named_arg1,int un_named_arg2,int un_named_arg3)
{
	Q_D(QIdentityProxyModel);
...
void QIdentityProxyModel::_q_sourceRowsAboutToBeMoved(const QModelIndex & un_named_arg1,int un_named_arg2,int un_named_arg3,
...
void QIdentityProxyModel::_q_sourceColumnsAboutToBeInserted(const QModelIndex & un_named_arg1,int un_named_arg2,int un_named_arg3)
{
	Q_D(QIdentityProxyModel);
	d->_q_sourceColumnsAboutToBeInserted(un_named_arg1, un_named_arg2, un_named_arg3);
}

void QIdentityProxyModel::_q_sourceColumnsInserted(const QModelIndex & un_named_arg1,int un_named_arg2,int un_named_arg3)
{
	Q_D(QIdentityProxyModel);
	d->_q_sourceColumnsInserted(un_named_arg1, un_named_arg2, un_named_arg3);
}

void QIdentityProxyModel::_q_sourceColumnsAboutToBeRemoved(const QModelIndex & un_named_arg1,int un_named_arg2,int un_named_arg3)
{
	Q_D(QIdentityProxyModel);
	d->_q_sourceColumnsAboutToBeRemoved(un_named_arg1, un_named_arg2, un_named_arg3);
}

void QIdentityProxyModel::_q_sourceColumnsRemoved(const QModelIndex & un_named_arg1,int un_named_arg2,int un_named_arg3)
{
	Q_D(QIdentityProxyModel);
	d->_q_sourceColumnsRemoved(un_named_arg1, un_named_arg2, un_named_arg3);
}

void QIdentityProxyModel::_q_sourceColumnsAboutToBeMoved(const QModelIndex & un_named_arg1,int un_named_arg2,int un_named_arg3,
      const QModelIndex & un_named_arg4,int un_named_arg5)
{
	Q_D(QIdentityProxyModel);
