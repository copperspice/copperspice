...
public:
    ...
    QItemSelectionRange intersect(const QItemSelectionRange &other) const; // ### Qt5/make QT4_SUPPORT
...
private:
    ...
    GUI_CS_SLOT_1(Private, void _q_rowsAboutToBeRemoved(const QModelIndex & un_named_arg1,int un_named_arg2,int un_named_arg3))
    GUI_CS_SLOT_2(_q_rowsAboutToBeRemoved)

    GUI_CS_SLOT_1(Private, void _q_columnsAboutToBeInserted(const QModelIndex & un_named_arg1,int un_named_arg2,int un_named_arg3))
    GUI_CS_SLOT_2(_q_columnsAboutToBeInserted)

    GUI_CS_SLOT_1(Private, void _q_rowsAboutToBeInserted(const QModelIndex & un_named_arg1,int un_named_arg2,int un_named_arg3))
