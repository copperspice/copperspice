...
class QPixelFormat
{
 ...
 public:
   ...
   constexpr inline ColorModel colorModel() const   { return ColorModel(get(ModelField, ModelFieldWidth)); }
   ...
   constexpr inline uchar greenSize() const  { return get(SecondField, SecondFieldWidth); }
   constexpr inline uchar blueSize() const  { return get(ThirdField, ThirdFieldWidth); }

   constexpr inline uchar cyanSize() const  { return get(FirstField, FirstFieldWidth); }
   constexpr inline uchar magentaSize() const  { return get(SecondField, SecondFieldWidth); }
   constexpr inline uchar yellowSize() const  { return get(ThirdField, ThirdFieldWidth); }
   constexpr inline uchar blackSize() const  { return get(FourthField, FourthFieldWidth); }

   constexpr inline uchar hueSize() const  { return get(FirstField, FirstFieldWidth); }
   constexpr inline uchar saturationSize() const  { return get(SecondField, SecondFieldWidth); }
   constexpr inline uchar lightnessSize() const  { return get(ThirdField, ThirdFieldWidth); }
   constexpr inline uchar brightnessSize() const  { return get(ThirdField, ThirdFieldWidth); }

   constexpr inline uchar alphaSize() const  { return get(AlphaField, AlphaFieldWidth); }
   ...
   constexpr inline AlphaUsage alphaUsage() const  { return AlphaUsage(get(AlphaUsageField, AlphaUsageFieldWidth)); }
   constexpr inline AlphaPosition alphaPosition() const  { return AlphaPosition(get(AlphaPositionField, AlphaPositionFieldWidth)); }
   constexpr inline AlphaPremultiplied premultiplied() const  { return AlphaPremultiplied(get(PremulField, PremulFieldWidth)); }
   constexpr inline TypeInterpretation typeInterpretation() const  { return TypeInterpretation(get(TypeInterpretationField, TypeInterpretationFieldWidth)); }
   constexpr inline ByteOrder byteOrder() const  { return ByteOrder(get(ByteOrderField, ByteOrderFieldWidth)); }

   constexpr inline YUVLayout yuvLayout() const  { return YUVLayout(get(SubEnumField, SubEnumFieldWidth)); }
   constexpr inline uchar subEnum() const  { return get(SubEnumField, SubEnumFieldWidth); }
...
constexpr
QPixelFormat::QPixelFormat(ColorModel mdl, uchar firstSize, uchar secondSize, uchar thirdSize, uchar fourthSize,
