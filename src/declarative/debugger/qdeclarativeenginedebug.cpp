...
void QDeclarativeEngineDebugPrivate::remove(QDeclarativeEngineDebug *c, QDeclarativeDebugRootContextQuery *q)
{
   if (c && q) {
      QDeclarativeEngineDebugPrivate *p = static_cast<QDeclarativeEngineDebugPrivate *>
                                          (QDeclarativeEngineDebugPrivate::cs_getPrivate(c));
...
void QDeclarativeEngineDebugPrivate::decode(QDataStream &ds, QDeclarativeDebugObjectReference &o, bool simple)
{
...
QDeclarativeDebugWatch *QDeclarativeEngineDebug::addWatch(const QDeclarativeDebugContextReference &, const QString &,
      QObject *)
{
...
QDeclarativeDebugObjectExpressionWatch *QDeclarativeEngineDebug::addWatch(const QDeclarativeDebugObjectReference
      &object, const QString &expr, QObject *parent)
{
   Q_D(QDeclarativeEngineDebug);
...
QDeclarativeDebugRootContextQuery *QDeclarativeEngineDebug::queryRootContexts(const QDeclarativeDebugEngineReference
...
QDeclarativeDebugObjectQuery *QDeclarativeEngineDebug::queryObjectRecursive(const QDeclarativeDebugObjectReference
...
QDeclarativeDebugExpressionQuery *QDeclarativeEngineDebug::queryExpressionResult(int objectDebugId, const QString &expr,
      QObject *parent)
{
   Q_D(QDeclarativeEngineDebug);
...
QDeclarativeDebugObjectReference::operator=(const QDeclarativeDebugObjectReference &o)
{
   ...
   m_class = o.m_class;
   m_idString = o.m_idString;
   m_name = o.m_name;
   m_source = o.m_source;
   m_contextDebugId = o.m_contextDebugId;
   m_needsMoreData = o.m_needsMoreData;
...
QDeclarativeDebugFileReference &QDeclarativeDebugFileReference::operator=(const QDeclarativeDebugFileReference &o)
{
   ...
   m_columnNumber = o.m_columnNumber;
   return *this;
}
      ...
      QDeclarativeDebugPropertyReference &o)
{
   ...
   m_name = o.m_name;
   m_value = o.m_value;
   m_valueTypeName = o.m_valueTypeName;
