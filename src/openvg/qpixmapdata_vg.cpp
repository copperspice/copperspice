...
{
    // If the image was imported, then skip the hibernation, there is no sense in copying it back 
    // to main memory because the data is most likely shared between several processes.
