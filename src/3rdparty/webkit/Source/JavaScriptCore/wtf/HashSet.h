...
namespace WTF {
    ...
    inline pair<typename HashSet<T, U, V>::iterator, bool> HashSet<T, U, V>::add(const ValueType& value)
    {
        ...
        return std::make_pair(typename HashSet<T, U, V>::iterator(temp.first), temp.second);
    }
    ...
    HashSet<Value, HashFunctions, Traits>::add(const T& value)
    {
        ...
        return std::make_pair(typename HashSet<Value, HashFunctions, Traits>::iterator(temp.first), temp.second);
    }
