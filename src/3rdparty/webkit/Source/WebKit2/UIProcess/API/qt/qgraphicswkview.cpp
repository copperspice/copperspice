    ...
    , d(new QGraphicsWKViewPrivate(this))
{
    ...
    connect(d->page, SIGNAL(titleChanged(const QString &)), this, SIGNAL(titleChanged(const QString &)));
    ...
    connect(d->page, SIGNAL(toolTipChanged(const QString &)), this, SLOT(onToolTipChanged(const QString &)));
}
