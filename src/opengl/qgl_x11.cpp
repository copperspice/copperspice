...
QGLOverlayWidget::QGLOverlayWidget(const QGLFormat &format, QGLWidget *parent, const QGLWidget *shareWidget)
      ...
      QGLContext::BindOptions options)
{
   ...
   if ( (hasAlpha && !glxRGBAPixmapConfig) || (!hasAlpha && !glxRGBPixmapConfig) ) {
      ...
      int configAttribs[] = {
         ...
         GLX_Y_INVERTED_EXT, static_cast<int>(options & QGLContext::CanFlipNativePixmapBindOption ? GLX_DONT_CARE : False),
         XNone
      };
