                                 ...
                                 const JSC::ArgList &scriptArgs)
{
    ...
    return callQtMethod(exec, QMetaMethod::Method, thisQObject, scriptArgs,meta, data->initialIndex, data->maybeOverloaded);
}
    ...
    : QMetaObjectWrapperObject(exec, &Qt::staticMetaObject(), /*ctor=*/JSC::JSValue(), structure)
{
    putDirectFunction(exec, new (exec) JSC::NativeFunctionWrapper(exec, 
         prototypeFunctionStructure, /*length=*/0, JSC::Identifier(exec, "className"), qmetaobjectProtoFuncClassName), JSC::DontEnum);
}
