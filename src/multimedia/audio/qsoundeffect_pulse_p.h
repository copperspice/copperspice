...
private:
    CS_SLOT_1(Private, void decoderError())
    CS_SLOT_2(decoderError)
    CS_SLOT_1(Private, void sampleReady())
    CS_SLOT_2(sampleReady)
    CS_SLOT_1(Private, void uploadSample())
    CS_SLOT_2(uploadSample)
    CS_SLOT_1(Private, void contextReady())
    CS_SLOT_2(contextReady)
    CS_SLOT_1(Private, void contextFailed())
    CS_SLOT_2(contextFailed)
    CS_SLOT_1(Private, void underRun())
    CS_SLOT_2(underRun)
    CS_SLOT_1(Private, void prepare())
    CS_SLOT_2(prepare)
    CS_SLOT_1(Private, void streamReady())
    CS_SLOT_2(streamReady)
    CS_SLOT_1(Private, void emptyComplete(void * stream,bool reload))
    CS_SLOT_2(emptyComplete)

    CS_SLOT_1(Private, void handleAvailabilityChanged(bool available))
