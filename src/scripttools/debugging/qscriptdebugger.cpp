...
QScriptDebugger::~QScriptDebugger()
{
   ...
   if ((scriptDebuggerCount == 0) && eventCallbackRegistered) {
      ...
      // BROOM (script tools)
      // QInternal::unregisterCallback(QInternal::EventNotifyCallback, scriptDebuggerEventCallback);
   }
}
...
void QScriptDebugger::setFrontend(QScriptDebuggerFrontend *frontend)
{
   ...
   if (frontend) {
      ...
      if (!eventCallbackRegistered) {
         ...
         // BROOM (script tools)
         // QInternal::registerCallback(QInternal::EventNotifyCallback,scriptDebuggerEventCallback);
      }
   }
}
...
void QScriptDebugger::setConsoleWidget(QScriptDebuggerConsoleWidgetInterface *consoleWidget)
{
   ...
   if (consoleWidget) {
      ...
      QObject::connect(consoleWidget, SIGNAL(lineEntered(const QString &)), this, SLOT(_q_onLineEntered(const QString &)));
...
void QScriptDebugger::setStackWidget(QScriptDebuggerStackWidgetInterface *stackWidget)
{
   ...
   if (stackWidget) {
      ...
      QObject::connect(stackWidget, SIGNAL(currentFrameChanged(int)), this, SLOT(_q_onCurrentFrameChanged(int)));
   }
}
...
void QScriptDebugger::setScriptsWidget(QScriptDebuggerScriptsWidgetInterface *scriptsWidget)
{
   ...
   if (scriptsWidget) {
      ...
      QObject::connect(scriptsWidget, SIGNAL(currentScriptChanged(qint64)), this, SLOT(_q_onCurrentScriptChanged(qint64)));
      QObject::connect(d->scriptsWidget, SIGNAL(scriptLocationSelected(int)), this, SLOT(_q_onScriptLocationSelected(int)));
   }
}
...
void QScriptDebugger::setCodeFinderWidget(QScriptDebuggerCodeFinderWidgetInterface *codeFinderWidget)
{
   ...
   if (codeFinderWidget) {
      QObject::connect(codeFinderWidget, SIGNAL(findRequest(const QString &, int)),
                       this, SLOT(_q_onFindCodeRequest(const QString &, int)));
   }
...
QAction *QScriptDebugger::interruptAction(QObject *parent) const
{
   ...
   if (!d->interruptAction) {
      ...
      QObject::connect(d->interruptAction, SIGNAL(triggered()), that, SLOT(_q_interrupt()));
   }
...
QAction *QScriptDebugger::continueAction(QObject *parent) const
{
   ...
   if (!d->continueAction) {
      ...
      QObject::connect(d->continueAction, SIGNAL(triggered()), that, SLOT(_q_continue()));
   }
...
QAction *QScriptDebugger::stepIntoAction(QObject *parent) const
{
   ...
   if (!d->stepIntoAction) {
      ...
      QObject::connect(d->stepIntoAction, SIGNAL(triggered()), that, SLOT(_q_stepInto()));
   }
...
QAction *QScriptDebugger::stepOverAction(QObject *parent) const
{
   ...
   if (!d->stepOverAction) {
      ...
      QObject::connect(d->stepOverAction, SIGNAL(triggered()), that, SLOT(_q_stepOver()));
   }
...
QAction *QScriptDebugger::stepOutAction(QObject *parent) const
{
   ...
   if (!d->stepOutAction) {
      ...
      QObject::connect(d->stepOutAction, SIGNAL(triggered()), that, SLOT(_q_stepOut()));
   }
...
QAction *QScriptDebugger::runToCursorAction(QObject *parent) const
{
   ...
   if (!d->runToCursorAction) {
      ...
      QObject::connect(d->runToCursorAction, SIGNAL(triggered()), that, SLOT(_q_runToCursor()));
   }
...
QAction *QScriptDebugger::toggleBreakpointAction(QObject *parent) const
{
   ...
   if (!d->toggleBreakpointAction) {
      ...
      QObject::connect(d->toggleBreakpointAction, SIGNAL(triggered()), that, SLOT(_q_toggleBreakpoint()));
   }
...
QAction *QScriptDebugger::clearErrorLogAction(QObject *parent) const
{
   ...
   if (!d->clearErrorLogAction) {
      ...
      QObject::connect(d->clearErrorLogAction, SIGNAL(triggered()), that, SLOT(_q_clearErrorLog()));
   }
...
QAction *QScriptDebugger::clearConsoleAction(QObject *parent) const
{
   ...
   if (!d->clearConsoleAction) {
      ...
      QObject::connect(d->clearConsoleAction, SIGNAL(triggered()), that, SLOT(_q_clearConsole()));
   }
...
QAction *QScriptDebugger::findInScriptAction(QObject *parent) const
{
   ...
   if (!d->findInScriptAction) {
      ...
      d->findInScriptAction->setEnabled( (d->codeFinderWidget != 0)
                                         && (d->codeWidget != 0) && (d->codeWidget->currentView() != 0));

      QObject::connect(d->findInScriptAction, SIGNAL(triggered()), that, SLOT(_q_findInScript()));
   }
...
QAction *QScriptDebugger::findNextInScriptAction(QObject *parent) const
{
   ...
   if (!d->findNextInScriptAction) {
      ...
      QObject::connect(d->findNextInScriptAction, SIGNAL(triggered()), that, SLOT(_q_findNextInScript()));
   }
...
QAction *QScriptDebugger::findPreviousInScriptAction(QObject *parent) const
{
   ...
   if (!d->findPreviousInScriptAction) {
      ...
      QObject::connect(d->findPreviousInScriptAction, SIGNAL(triggered()), that, SLOT(_q_findPreviousInScript()));
   }
...
QAction *QScriptDebugger::goToLineAction(QObject *parent) const
{
   ...
   if (!d->goToLineAction) {
      ...
      QObject::connect(d->goToLineAction, SIGNAL(triggered()), that, SLOT(_q_goToLine()));
   }
