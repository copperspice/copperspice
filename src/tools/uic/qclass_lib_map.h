...
QT_CLASS_LIB(QMetaObject, QtCore, qmetaobject.h)
...
QT_CLASS_LIB(QSound, QtMultimedia, qsound.h)
...
QT_CLASS_LIB(QNetworkAccessManager, QtNetwork, qnetaccess_manager.h)
