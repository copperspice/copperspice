...
QT_CLASS_LIB(QAbstractNetworkCache, QtNetwork, qabstract_networkcache.h)
...
QT_CLASS_LIB(QGenericPlugin, QtGui, qgenericplugin.h)
QT_CLASS_LIB(QGenericPluginFactory, QtGui, qgenericpluginfactory.h)
...
QT_CLASS_LIB(QKeySequence, QtGui, qkeysequence.h)
QT_CLASS_LIB(QKeySequenceEdit, QtGui, qkeysequenceedit.h)
...
QT_CLASS_LIB(QMutexLocker, QtCore, qmutex.h)
QT_CLASS_LIB(QNetworkAccessManager, QtNetwork, qaccess_manager.h)
QT_CLASS_LIB(QNetworkAddressEntry, QtNetwork, qnetworkinterface.h)
QT_CLASS_LIB(QNetworkCacheMetaData, QtNetwork, qabstract_networkcache.h)
...
QT_CLASS_LIB(QNetworkCookie, QtNetwork, qnetwork_cookie.h)
QT_CLASS_LIB(QNetworkCookieJar, QtNetwork, qnetwork_cookiejar.h)
QT_CLASS_LIB(QNetworkDiskCache, QtNetwork, qnetwork_diskcache.h)
...
QT_CLASS_LIB(QNetworkReply, QtNetwork, qnetwork_reply.h)
QT_CLASS_LIB(QNetworkRequest, QtNetwork, qnetwork_request.h)
...
QT_CLASS_LIB(QOpenGLWidget, QtGui, qopenglwidget.h)
...
QT_CLASS_LIB(QRegularExpression, QtCore, qregularexpression.h)
QT_CLASS_LIB(QRegularExpressionMatch, QtCore, qregularexpression.h)
...
QT_CLASS_LIB(QMallocDeleter, QtCore, qscopedpointer.h)
...
QT_CLASS_LIB(QString16, QtCore, qstring16.h)
QT_CLASS_LIB(QString8, QtCore, qstring8.h)
...
QT_CLASS_LIB(QStringParser, QtCore, qstringparser.h)
QT_CLASS_LIB(QStringView, QtCore, qstring.h)
...
QT_CLASS_LIB(QWindowSystemInterface, QtGui, qwindowsysteminterface.h)
...
QT_CLASS_LIB(QXmlStringView, QtCore, qxmlstream.h)
QT_CLASS_LIB(QXmlStringView, QtXml, qxmlstream.h)
...
QT_CLASS_LIB(QtMsgHandler, QtCore, qlog.h)
