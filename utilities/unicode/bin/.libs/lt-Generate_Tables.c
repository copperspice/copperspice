...
/* bin/.libs/lt-Generate_Tables.c - temporary wrapper executable for .libs/Generate_Tables.exe
   Generated by libtool (GNU libtool) 2.4.2

   The bin/Generate_Tables program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "z:\\cs5_lib\\lib;z:\\cs5_lib\\bin;";
const char * TARGET_PROGRAM_NAME = "Generate_Tables.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# bin/Generate_Tables - temporary wrapper script for .libs/Generate_Tables.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The bin/Generate_Tables program cannot be directly executed until all the lib", f);
  fputs ("tool\n", f);
  ...
  fputs ("    echo \"Generate_Tables.exe:bin/Generate_Tables:${LINENO}: libtool wrapper (G", f);
  fputs ("NU libtool) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"Generate_Tables.exe:bin/Generate_Tables:${LINENO}: newargv[$lt_dump_", f);
  fputs ("args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"Generate_Tables.exe:bin/Generate_Tables:${LINENO}: newargv[0]: $", f);
  ...
  fputs ("\n", f);
  fputs ("  program='Generate_Tables.exe'\n", f);
  ...
  fputs ("    PATH=/z/cs5_lib/lib:/z/cs5_lib/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
